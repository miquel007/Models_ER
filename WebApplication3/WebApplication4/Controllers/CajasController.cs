...
namespace WebApplication4.Models
{
    ...
    public class CajasController : ControllerBase
    {
        ...
        public async Task<ActionResult<Caja>> PostCaja(Caja caja)
        {
            ...
            {
                if (CajaExists(caja.num_referencia))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetCaja", new { id = caja.num_referencia }, caja);
        }
        ...
        {
            return _context.Cajas.Any(e => e.num_referencia == id);
        }
    }
}
